...
function arraySquare(arrayInput: number[]) {
  let arrrayOutput = [];
...
function arrayReverse(array: any[]) {
  let temp: any = [];
...
function removeFalse(array: any[]) {
  for (let i = 0; i < array.length; i++) {
    if (
      array[i] == null ||
      array[i] == false ||
...
function checkArrayElement(x: any, array: any[]) {
  for (let i = 0; i < array.length; i++) {
    if (array[i] == x) {
      return i;
    }
...
function checkSmallestNumberArray(array: number[]) {
  let min = array[0];
  for (let i = 0; i < array.length; i++) {
    if (array[i] < min) {
      min = array[i];
...
console.log(
  "Smallest number in the array is ",
  checkSmallestNumberArray(arrayQ20)
);
console.log("");
//Question 21
console.log("Quesiton-21:");
function productArray(array: number[]) {
  let temp = 1;
  for (let i = 0; i < array.length; i++) {
    temp = temp * array[i];
  }
...
console.log(
  "Element with Character Length 4 are: ",
  filterByLength(arrayQ22, 5)
);
console.log("");
//Question 23
...
function findOccurences(array: any[], n: any) {
  let count = 0;
  for (let i = 0; i < array.length; i++) {
    if (array[i] == n) {
      count++;
...
function farenheitToCelcius(f: number) {
  let c: number;
  c = ((f - 32) * 5) / 9;
  return c;
}
...
function stringCharacterCount(str: string, char: string) {
  let count = 0;
...
function checkCompletedTasks(array: any[]) {
  for (let i = 0; i < array.length; i++) {
...
function sortArrayAscendingOrder(array: number[]) {
  for (let i = 0; i < array.length; i++) {
...
function revserArray(array: any[]) {
  let temp = [];
  for (let i = 0; i < array.length; i++) {
    temp[i] = array[array.length - 1 - i];
  }
...
console.log("");
//Question 35 - Sir did not understand. What to do for this quesiton
